...
export default class Testimonials extends Component {
    ...
    addtestimonial_api = (e) => { 
        ...
        axios
            .post(`http://134.209.157.211/champbakery/public/api/${this.state.testimonial_id ? `edit_testimonial/${this.state.testimonial_id}` : `add_testimonials`}`, data, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
    ...
    onCancel = () => {
        if (this.state.addtestimonialsuccess === true || this.state.successs === true) {
    ...
    render() {
        ...
        const tableData = currentPosts ? currentPosts.map((x, i) => (
            <tr id="dataid53" role="row" className="even" key={i}>
                ...
                <td>{x.created_at}</td>
                <td>
                    <button type="button" className="btn btn-warning" data-toggle="modal" data-target="#myModaltest" data-backdrop="static" data-keyboard="false" onClick={(e) => this.edit_testimonial(x.id)}>
                        Edit
                    </button>
                    &nbsp;
        ...
        const { deleteValid, successs, addtestimonialsuccess } = this.state;
        return (
            <div>
                {deleteValid ? (
                    ...
                    <SweetAlert
                        ...
                        title="Are you sure?"
                        onConfirm={(e) => this.delete_testimonial(e)}
                        ...
                        <div className="content-inner">
                            <section className="dashboard-counts no-padding-bottom">
                                <div className="container-fluid">
                                    <div className="model">
                                        {/* <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#myModaltest" data-backdrop="static" data-keyboard="false">
                                            Add Testimonial
                                        </button> */}
                                        <div className="modal" id="myModaltest">
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <h5 className="modal-title" id="exampleModalLabel">Add New Testimonial</h5>
                                                        <button type="button" className="close" data-dismiss="modal" aria-label="Close" onClick={this.dismiss}><span aria-hidden="true">×</span>
                                                        </button>
                                                    </div>
                                                    <form id="add_banner" onSubmit={(e) => this.addtestimonial_api(e)}>
                                                        <div className="modal-body">
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <textarea className="form-control" id="content" name="content" value={this.state.content} placeholder="You can add only 150 words...." onChange={(e) => this.handleChange1(e)} required maxlength="500"></textarea>
                                                ...
                                                <div className="series_one">
                                                    <div className="series_five">
                                                        <div className="series_three">
                                                            <div className="testi">
                                                                <h6>All Testimonials</h6>
                                                            </div>
                                                            <div className="moinals">
                                                                <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#myModaltest" data-backdrop="static" data-keyboard="false">
                                                                    Add Testimonial
                                                                </button>
                                                        ...
                                                        <table className="table table-striped table-bordered zero-configuration dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                            <thead>
                                                                <tr role="row"><th className="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="#: activate to sort column descending" style={{ width: "58px" }}>#</th>
                                                                    <th className="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Image: activate to sort column ascending" style={{ width: "260px" }}>Headings</th>
                                                                    ...
                                                                    <th className="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Item Name: activate to sort column ascending" style={{ width: "260px" }}>Image</th>
                                                                    ...
                                                                    <th className="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style={{ width: "167px" }}>Action</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                {tableData}
